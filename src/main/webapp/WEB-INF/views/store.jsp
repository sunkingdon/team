                                        ...
                                        <div class="product-image ">
                                            <div class="product-thumbnail">
                                                <a href="product_single.html" title="">
                                                    <img class="product-featured-image" src="${pageContext.request.contextPath}/resources/img/bg-img/store1.jpg"
                                                        alt="">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product-block">
                                        ...
                                        <div class="product-caption">
                                            ...
                                            <div class="product-form-cart">
                                                ...
                                                <a href="product_single.html" class="add_to_cart_button"><i
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product-block">
                                        <div class="product-image ">
                                            <div class="product-thumbnail">
                                                <a href="product_single.html" title="">
                                                    <img class="product-featured-image" src="${pageContext.request.contextPath}/resources/img/bg-img/store3.jpg"
                                                        alt="">
                                                </a>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product-block">
                                        <div class="product-image ">
                                            <div class="product-thumbnail">
                                                <a href="product_single.html" title="">
                                                    <img class="product-featured-image" src="${pageContext.request.contextPath}/resources/img/bg-img/store4.jpg"
                                                        alt="">
                                                </a>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product-block">
                                        <div class="product-image ">
                                            <div class="product-thumbnail">
                                                <a href="product_single.html" title="">
                                                    <img class="product-featured-image" src="${pageContext.request.contextPath}/resources/img/bg-img/store5.jpg"
                                                        alt="">
                                                </a>
                                            </div>
                            ...
                            <div class="row row-products">
                                            ...
                                            <div class="product-caption">
                                                ...
                                                <div class="product-meta">
                                                    <h4 class="product-name">
                                                        <a href="product_single.html" title="">Total War: THREE KINGDOMS
                                                        </a>
                                                    </h4>
                                                    <div class="product-price">
                                                        <ins>
                                                            <span class="amout">$29.19</span>
                                                        </ins>
                                                        <del>
                                                            <span class="amout">$44.45</span>
                                                        </del>
                                                ...
                                                <div class="excerpt">
                                                    ...
                                                    D300 combines brand new technologies with advanced features
                                                    inherited from...
                                                    Latest Intel mobile architecture Powered by the most
                                                    advanced mobile processors
                                                    from Intel, the new Core 2 Duo...
                                                </div>
                                ...
                                <div class="col-md-12 product-block-list">
                                    <div class="row">
                                                ...
                                                <div class="product-thumbnail">
                                                    <a href="#" title="">
                                                        <img class="product-featured-image"
                                                            src="${pageContext.request.contextPath}/resources/img/bg-img/store1.jpg" alt="">
                                                    </a>
                                                </div>
                                            </figure><!-- /.product-image -->
                                        </div>
                                        <div class="col-lg-8 col-md-12 col-sm-12">
                                            <div class="product-caption">
                                                <span class="posted_in"><a href="#" rel="tag">PSR</a></span>
                                                <div class="product-meta">
                                                    <h4 class="product-name">
                                                        <a href="product_single.html" title="">Costume Battle
                                                            Quest</a>
                                                    </h4>
                                                    <div class="product-price">
                                                        <ins>
                                                ...
                                                <div class="product-footer">
                                                    <a href="cart.html" class="btns btns-default add_to_cart_button"><i
                                                            class="fa fa-shopping-basket" aria-hidden="true"></i>Add to
                                                        Cart</a>
                                                    <div class="product-actions">
                                                        <a href="#" data-id=""
                                                            class="btns wishlist product-quick-whistlist"
                                                            title="Add to whistlist">
                                                            <i class="fa fa-heart-o"></i>
                                                        </a>

                                                        <a href="#" data-id=""
                                                            class="btns product-quick-compare btns-compare"
                                                            title="Compare">
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <figure class="product-image">
                                                <div class="product-thumbnail">
                                                    <a href="#" title="">
                                                        <img class="product-featured-image"
                                                            src="${pageContext.request.contextPath}/resources/img/bg-img/store2.jpg" alt="">
                                                    </a>
                                                </div>
                                            </figure><!-- /.product-image -->
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <figure class="product-image">
                                                <div class="product-thumbnail">
                                                    <a href="#" title="">
                                                        <img class="product-featured-image"
                                                            src="${pageContext.request.contextPath}/resources/img/bg-img/store3.jpg" alt="">
                                                    </a>
                                                </div>
                                            </figure><!-- /.product-image -->
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <figure class="product-image">
                                                <div class="product-thumbnail">
                                                    <a href="#" title="">
                                                        <img class="product-featured-image"
                                                            src="${pageContext.request.contextPath}/resources/img/bg-img/store4.jpg" alt="">
                                                    </a>
                                                </div>
                                            </figure><!-- /.product-image -->
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <figure class="product-image">
                                                <div class="product-thumbnail">
                                                    <a href="#" title="">
                                                        <img class="product-featured-image"
                                                            src="${pageContext.request.contextPath}/resources/img/bg-img/store5.jpg" alt="">
                                                    </a>
                                                </div>
                                            </figure><!-- /.product-image -->
                                        </div>
